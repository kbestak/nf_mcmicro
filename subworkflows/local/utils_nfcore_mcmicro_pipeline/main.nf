...
def validateInputSamplesheetMarkersheet ( samples, markers ) {
    ...
    def marker_cycles = markers.collect{ channel_number, cycle_number, marker_name, filter, excitation_wavelength, emission_wavelength, segmentation_channel, quantification_type -> cycle_number }
